...
public class TestCircle {  // Save as "TestCircle.java"
   public static void main(String[] args) {
      ...
      System.out.println("The circle has radius of " 
         + c2.getRadius() + " la couleur est " + c2.getColor() + " and area of " + c2.getArea());
      //The circle has radius of 2.0 and area of 12.566370614359172
      Circle c3 = new Circle(4.5,"bleu");
      System.out.println("The circle has radius of " 
    	         + c3.getRadius() +" la couleur est " + c3.getColor() + " and area of " + c3.getArea());
      Circle c4 = new Circle();   // construct an instance of Circle
      c4.setRadius(5);          // change radius
      System.out.println("radius is: " + c4.getRadius()+ "   "+c4.getArea()); // Print radius via getter
